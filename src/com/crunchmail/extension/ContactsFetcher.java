...
public class ContactsFetcher extends ContactsCrawler {
    ...
    public ContactsFetcher(Mailbox mbox, Account account, boolean debug, Set<String> existing) throws ServiceException {
        super(mbox, account, debug, existing, new String[] {ContactConstants.A_firstName, ContactConstants.A_lastName}, false);
    }

    public ContactsFetcher(Mailbox mbox, Account account, boolean debug, Set<String> existing, String[] includeFieldsDefault) throws ServiceException {
        super(mbox, account, debug, existing, new String[] {ContactConstants.A_firstName, ContactConstants.A_lastName}, false);
    }

    public ContactsFetcher(Mailbox mbox, Account account, boolean debug, Set<String> existing, String[] includeFieldsDefault, boolean forceConsiderShared) throws ServiceException {
        super(mbox, account, debug, existing, includeFieldsDefault, forceConsiderShared);
    }
